#Max Ivry
#program for creating word game  to find all words from random letter generator
...
#filename to be passed in to python
filename = sys.argv[1]
#define main function that finds all scores
def main():
    ...
    print('''Hello! Welcome to Word Hunt! Try to find as many three to five letter words as you can from five random letters!
You are allowed to use any letter more than once.''')
    ...
    if beginround == 'q':
        print("View the game results in " + filename + "! You will now return to the arcade!")
...
#define random_letters_function that returns eight random letters to user from alphabet
...
#define determine_computer_score function that reads infile, determines all possible words that can be created from random letters, and returns set of all possible words and corresponding score
...
#define determine_player_score function that takes in users words and random letters, determines how many words player correctly identified, and returns player score,
...
#define round_results function that takes in users words and allpossiblewords, displays words players correctly identified and words players missed to screeen (not value returning)
...
#define final_results function that takes in computer score, player score, and round count, and prints results to outfile
